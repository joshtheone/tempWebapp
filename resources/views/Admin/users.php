  ...
  <body class="hold-transition sidebar-mini">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            <td><?php echo $x ?></td>
                            <td><?php echo $user['full-name'] ?></td>
                            <td><?php echo $user['user-email'] ?></td>
                            <td><?php echo $user['user-phone'] ?></td>
                            <td><?php echo $user['user_level'] ?></td>
                            <td align="center">

                              <a href="#settings" class="btn btn-primary btn-xs" data-toggle="modal" data-id="<?php echo $user['id']; ?>" id="getsettings"><i class="fa fa-cogs"> </i> View settings</a>
                            </td>
                          </tr>
                        <?php
                          $x++;
    ...
    <script>
      ...
      $(document).ready(function() {
        ...
        $(document).on('click', '#getsettings', function(e) {
          e.preventDefault();
